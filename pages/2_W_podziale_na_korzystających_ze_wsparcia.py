...
import pandas as pd
from functions import process_data, recode_job_variables, create_multiple_variable_plot_percentages, create_year_list
...
if 'dataframe' in st.session_state:
    ...
    create_multiple_variable_plot_percentages(df_persons, 'Czy znalazł pracę - binarna', 'Czy się przebranżowił - binarna', 'Czy praca związana z kursem - binarna', 'Czy skorzystał ze wsparcia')
else:
